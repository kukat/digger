...
- [x] Real-device acceptance passes on iOS and Android over Wi-Fi and cellular, with VPN/network-transition coverage and both IPv4 and IPv6 resolver scenarios.
